...
import { PsadtService, getPsadtService } from '../services/psadt.js';
import type { TemplateOptions } from '../types/psadt.js';

describe('PsadtService', () => {
  let service: PsadtService;
