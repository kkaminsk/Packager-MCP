...
describe('LruCache', () => {
  ...
  beforeEach(() => {
    cache = new LruCache<string>(defaultConfig);
    vi.useFakeTimers();
  });
...
describe('CacheManager', () => {
  ...
  it('should create and return named caches', () => {
    const cache1 = manager.getCache<string>('test1');
    const cache2 = manager.getCache<string>('test2');
