...
tags: ["psadt", "best-practices", "patterns", "deployment", "v4.1.8"]
---

# PSADT v4 Best Practices

Best practices for creating reliable, maintainable PSADT v4.1.8 deployment packages, derived from real-world examples.

## Script Structure (v4.1.8)

### Use Function-Based Structure

In v4.1.8, use separate functions for each deployment type:
...
### Use AppProcessesToClose (v4.1.8)
...
v4.1.8 recommends splatting for cleaner code:
...
### No ServiceUI Required (v4.1.8)

v4.1.8 handles user interaction without ServiceUI:
...
### DeployMode Auto (v4.1.8 Default)

Let PSADT decide when to show UI:

```powershell
# With Auto mode (default in v4.1.8):
...
5. **Don't use ServiceUI** - v4.1.8 handles user interaction natively
